...
{"id": "FLIP-07", "题": "太阳下后·去芍药/加附子",
 ...
 "source_layer": "⛔**126C 补 `text_status=emended_by_hu`**：本条底本经胡老补字——"
                 ...
                 "⛔⛔ **126J 交叉核证**：`hu_lecture`（讲伤寒 §22）对同一条**不补字**，"
                 "以赵开美本／《玉函经》之「微寒」为正、斥成无己「微恶寒」为改。"
                 "⇒ 本组之分野项【脉微＋恶寒并见】**只在 C卷 之处理下成立**；"
                 "讲课本之读法为【微寒＝微陷于阴寒证】，**不涉脉**。"
                 "⇒ D3 未决，⛔ 不统一。见 `evidence/交叉核证_C02_…_126J.md`",
