...
{"id": "FLIP-03", "题": "§209·转矢气",
 "observable": "矢气（转／不转）",
 "competitor_set": "⭐**124批 由二支改三支**（反例攻击所得）：〔A·C卷·70353 §214〕「腹中**转气者，更服一升**；若**不转气者，勿更与之**；**明日又不大便，脉反微涩者，里虚也，为难治，不可更与承气汤也**」⇒ {有燥屎, 初头硬后必溏, **里虚·为难治**}。⛔又一次把多选一写成二选一（第三次）",
 ...
 "diagnostic_intervention": "⭐⭐**是**：少与小承气汤。**治疗前已预先规定两种结果各自意味什么**"
                            "⇒ 鉴别力强于一般疗效反推。⭐124批 补：胡老〔A·讲伤寒·218554 区〕「**既是试之，也是治之**」——**诊断性干预同时是治疗**，非纯诊断动作",
 "state_transition": "无",
 ...
 "counterexample_search": "⭐**124批 已执行**。式：`转失气|转矢气`72／`不转矢气`36，范围十二书。**结果：`scope_split`**——〔A·C卷·70353 §214〕同一试治同一观察而 decision 不同（转气→**更服小承气**而非升大承气），且多一支【脉反微涩⇒里虚为难治，不可更与承气】",
