...
{"id": "FLIP-03", "题": "§209·转矢气",
 ...
 "diagnostic_intervention": "⭐⭐**是**：少与小承气汤。**治疗前已预先规定两种结果各自意味什么**"
                            "⇒ 鉴别力强于一般疗效反推。⭐124批 补：胡老〔A·讲伤寒·218554 区〕「**既是试之，也是治之**」——**诊断性干预同时是治疗**，非纯诊断动作。⚠此条出自 §209 讲解，**不受 125批 §214 撤销之影响**",
 "state_transition": "无",
...
{"id": "FLIP-04", "题": "伤寒有停水·渴/呕",
 ...
 "source_layer": "⛔**L1 疑脱漏**：注文作「原条文『伤寒汗出』后，**似脱漏『脉浮数，小便不利』七字**，"
 ...
 "counterexample_search": "⛔未做",
 "falsifier": "若他本无此脱漏而文义自足，则该补字之说不成立，本组瓦解。**未查异本**（⚠126K：原作「胡老之补字」，归因已降）",
...
{"id": "FLIP-07", "题": "太阳下后·去芍药/加附子",
 ...
 "source_layer": "⛔⛔**126K 改写当前状态**（原记 `emended_by_hu`／「本条底本经胡老补字」——**撤回**）："
                 "**C卷 注解提出补「脉」字**〔A·C卷·29360〕；**该段归属未定**（C卷 speaker=uncertain）。"
                 "**讲课文本（讲伤寒 §22〔26528,26900)）采另一读法**：以「若微寒者」为正、"
                 "斥成无己「微恶寒」为改，**不补字**，读作「微寒＝微陷于阴寒证」。"
                 "⇒ **当前不能作为胡老本人补字的确定证据**；`text_status = disputed_cross_source`。"
                 "⛔ 本栏**不裁定**哪种读法正确。⚠ 故本组之分野项**在两读法下不同**："
                 "C卷 读法作【脉微＋恶寒并见】，讲课本读法作【微寒】而**不涉脉**。"
                 "详见 `evidence/交叉核证_C02_第21_22条_讲伤寒与C卷_126J.md`（126K 已收紧措辞）",
...
def main():
    ...
    w("3. **`ordinal` 之取值只覆盖三个变量**（脓成熟度、寒热程度、疼痛程度），"
      "其中**疼痛程度之原文锚本批未查**，为占位。")
    w("4. **FLIP-04 底本未定**（⚠126K：原作「胡老补字」——该语不见于 hu_lecture，归因已降为 hu_via_editor 未定），故其决定变量本批不提出。")
